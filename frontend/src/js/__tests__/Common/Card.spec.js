...
import { CardDescriptionLabel, CardFeatureLabel, CardHeader, CardLabel } from '../../components/Common/Card';
...
describe('Card', () => {
  ...
  it('should render card header with correct links', () => {
    const { container } = render(
      <BrowserRouter>
        <CardHeader cardMainLinkPath={minProps.cardMainLinkPath}

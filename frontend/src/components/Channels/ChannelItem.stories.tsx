...
const Template: Story<ChannelItemProps> = args => <ChannelItem {...args} />;
export const ShowArch = Template.bind({});
...
export const NoPackage = Template.bind({});
NoPackage.args = {
  channel: {
    id: '30b6ffa6-e6dc-4a01-bea6-9ce7f1a5bb34',
    name: 'edge',
...
export const NoArch = Template.bind({});
NoArch.args = {
  ...ShowArch.args,
  showArch: false,
};

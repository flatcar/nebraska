...
- **OEM distribution metric:** New `nebraska_application_instances_by_oem` Prometheus metric exposing per-application instance counts grouped by OEM/platform (e.g. AWS, Azure, VMware). Instances without a recorded OEM are excluded. ([#2239](https://github.com/flatcar/Flatcar/issues/2239))

...
func dbSample_dataSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "db/sample_data.sql", size: 15541, mode: os.FileMode(0644), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x6e, 0x2c, 0xe1, 0xcf, 0x8c, 0xb7, 0x40, 0xc3, 0x7a, 0x4f, 0xef, 0xe9, 0x4c, 0xda, 0xe3, 0xce, 0xee, 0xb1, 0x4b, 0x69, 0xb3, 0x69, 0x5, 0x7d, 0x4b, 0xab, 0xc6, 0x5, 0x41, 0x23, 0xed, 0xc3}}
	return a, nil
}

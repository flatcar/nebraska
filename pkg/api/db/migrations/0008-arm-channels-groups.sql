...
--    if not exists (select id from application limit 1) then
        ...
        -- insert ARM groups
        insert into groups values ('11a585f6-9418-4df0-8863-78b2fd3240f8', 'Stable (ARM)', 'For production clusters (ARM)', false, true, true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2015-09-19 05:09:34.269062', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', '5dfe7b12-c94a-470d-a2b6-2eae78c5c9f5');
        insert into groups values ('d112ec01-ba34-4a9e-9d4b-9814a685f266', 'Beta (ARM)', 'Promoted alpha releases, to catch bugs specific to your configuration (ARM)', false, true, true, false, 'Europe/Berlin', '15 minutes', 2, '60 minutes', '2015-09-19 05:09:34.273244', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', 'cf20698b-1f19-43d6-b6f6-d15c796cb217');
        insert into groups values ('e641708d-fb48-4260-8bdf-ba2074a1147a', 'Alpha (ARM)', 'Tracks current development work and is released frequently (ARM)', false, true, true, false, 'Europe/Berlin', '15 minutes', 1, '30 minutes', '2015-09-19 05:09:34.274911', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', 'def12ce0-3ba4-4649-b290-8843f3b455eb');
        insert into groups values ('b4b2fa22-c1ea-498c-a8ac-c1dc0b1d7c17', 'Edge (ARM)', 'Experimental features and patches (ARM)', false, true, true, false, 'Europe/Berlin', '15 minutes', 1, '30 minutes', '2018-04-10 10:25:39.677359+00', 'e96281a6-d1af-4bde-9a0a-97b76e56dc57', '30b6ffa6-e6dc-4a01-bea6-9ce7f1a5bb34');

...
update group_local set rollout_in_progress = true where group_id = '3fe10490-dd73-4b49-b72a-28ac19acfcdc';
...
insert into instance (id, ip, oem) values ('instance1', '10.0.0.1', 'aws');
insert into instance (id, ip, oem) values ('instance2', '10.0.0.2', 'aws');
insert into instance (id, ip, oem) values ('instance3', '10.0.0.3', 'vmware');
insert into instance (id, ip, oem) values ('instance4', '10.0.0.4', 'aws');
insert into instance (id, ip, oem) values ('instance5', '10.0.0.5', 'aws');
insert into instance (id, ip, oem) values ('instance6', '10.0.0.6', 'vmware');
insert into instance (id, ip, oem) values ('instance7', '10.0.0.7', 'azure');
insert into instance (id, ip, oem) values ('instance8', '10.0.0.8', 'aws');
insert into instance (id, ip, oem) values ('instance9', '10.0.0.9', 'aws');
insert into instance (id, ip, oem) values ('instance10', '10.0.0.10', 'vmware');
insert into instance (id, ip, oem) values ('instance11', '10.0.0.11', 'azure');
insert into instance (id, ip, oem) values ('instance12', '10.0.0.12', 'qemu');
